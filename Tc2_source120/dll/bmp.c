...
extern BOOL bCoolStartButton;
extern COLORREF CoolStartColorHigh, CoolStartColorLow, CoolStartColorFace;
...
HBITMAP ReadBitmap(HWND hwnd, char* fname, BOOL b)
{
	...
	if(b)
	{
		...
		{
			COLORREF col = bCoolStartButton?CoolStartColorFace:GetSysColor(COLOR_3DFACE);
